...
# Locals
#os.chdir("C:\\Users\\abdel\\GitHub\\interaction_network\\models\\")
#from graph import Graph, save_graphs
...
def main():
    ...
    t1 = time.time()
    duration = t1-t0
    print(f"Graph Construction: {duration//60} minutes, {duration%60} seconds")
